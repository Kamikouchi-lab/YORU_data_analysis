...
#read to CSV
data_path = "../datas/zebra__orientation_ap.csv"
...
# Only orientation
df_ori_data = filter(df_all_data, class == "0")
gp_ori = ggplot(data = df_ori_data, aes(x = no_of_images, y = AP_value, color = models)) + 
  geom_point(size = 1.5) +
...
ggsave("../graph/model_evaluation_orientation.png", gp_ori, width = 5, height = 6, dpi = 500)
ggsave("../graph/model_evaluation_orientation.svg", gp_ori, width = 5, height = 6, dpi = 500)
