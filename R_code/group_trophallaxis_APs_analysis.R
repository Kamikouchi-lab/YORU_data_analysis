...
Setting <- list(theme(plot.margin = unit(c(1, 1, 1, 1), "lines")),
                ...
                scale_y_continuous(limits = c(0.00, 1.05), breaks = seq(0.00, 1, 0.2), expand = c(0, 0)),
                scale_x_continuous(limits = c(0, 1100), breaks = seq(0, 1100, 200), expand = c(0, 0)),
...
#read to CSV
data_path = "../datas/group_trophallaxis_ap.csv"
...
# Only trophallaxis
df_tro_data = filter(df_all_data, class == "1")
...
ggsave("../graph/model_evaluation_group_trophallaxis.png", gp_tro, width = 5, height = 9, dpi = 500)
ggsave("../graph/model_evaluation_group_trophallaxis.svg", gp_tro, width = 5, height = 9, dpi = 500)