...
# ==== Settings ====
INPUT_XLSX = "TableS5_ant_tro_asoid_result_table.xlsx"   # put this .py next to the .xlsx or change path
SHEET_NAME = "ant_tro_asoid_result_table"
METRIC = "f1_score"   # "precision", "recall", "accuracy", or "f1_score"
OUT_PDF = "ant_trophallaxis_total_bar_with_groups_bw.pdf"
FIGSIZE = (6, 4)
# ==================
